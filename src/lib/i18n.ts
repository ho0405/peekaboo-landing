...
export const t = {
  en: {
    ...
    macInstallNotice: "Mac: Apple Developer approval is pending. After installation, right-click the app and select \"Open\" to run.",
    ...
    shortcut3Action: "Opacity preset (low)",
    shortcut4Action: "Opacity preset (mid)",
    shortcut5Action: "Opacity preset (high)",
    shortcut6Action: "Toggle always on top",
    shortcut7Action: "Quit",
    footerDeveloper: "Developer",
    footerBugReport: "Bug report",
    footerDaolConsulting: "Daol Consulting",
  },
  ko: {
    ...
    comingSoon: "준비중",
    macInstallNotice: "Mac: Apple Developer 승인이 아직 완료되지 않았습니다. 설치 후 앱을 오른쪽 클릭 → 열기로 실행해 주세요.",
    shortcutsTitle: "⌨️ 단축키",
    shortcutsDesc: "빠른 조작을 위한 단축키",
    shortcut1Action: "투명도 증가",
    shortcut2Action: "투명도 감소",
    shortcut3Action: "투명도 프리셋 (약함)",
    shortcut4Action: "투명도 프리셋 (중간)",
    shortcut5Action: "투명도 프리셋 (강함)",
    shortcut6Action: "항상 위 토글",
    shortcut7Action: "종료",
    footerDeveloper: "개발자",
